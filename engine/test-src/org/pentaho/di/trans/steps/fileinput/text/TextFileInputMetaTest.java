...
public class TextFileInputMetaTest {
  ...
  public void whenExportingResourcesWeGetFileObjectsOnlyFromFilesWithNotNullFileNames() throws Exception {
    ...
    inputMeta.inputFiles.fileName = new String[] { FILE_NAME_NULL, FILE_NAME_VALID_PATH };
    inputMeta.inputFiles.fileMask = new String[] { StringUtil.EMPTY_STRING, StringUtil.EMPTY_STRING };
